...
export function ClientLearningPage({ initialCourses }: { initialCourses: Course[] }) {
  const { isAuthenticated, user } = useKindeBrowserClient()
  const [courses, setCourses] = useState(initialCourses)

  useEffect(() => {
    // This ensures that the client-side state matches the server-side props
...
function CourseCard({ title, imageUrl, slug }: Course) {
  return (
